...
class BacktestBase(object):
    ...
    ptc: float
        proportional transacton costs per trade (buy or sell)
    ...
    plot_data:
        plots the closing price for the symbole
    get_date_price:
    ...
    def plot_data(self):
        """Plots the cosing prices for symbol.
        """
...
if __name__ == "__main__":
    ...
    bb.place_sell_order(10, units=3)
    bb.close_out(15)